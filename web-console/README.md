...
Web console source for the MyController server. Bootstrapped with [Create React App](https://github.com/facebook/create-react-app).
...
## Locales
Edit translation files in `public/locales/<lang>/translation.yaml` and commit them here. The UI loads those files at runtime (`/locales/{{lng}}/translation.yaml`).
